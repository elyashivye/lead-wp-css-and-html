...
'
            . '<label><input type="checkbox" name="terms_approved" value="1" required> מאשר/ת את תנאי השימוש ומדיניות הפרטיות</label><br>
'
...
'
    ...
    private static function get_default_template_css(): string {
        return '.lfb-demo-form{display:grid;gap:12px;max-width:520px;}
'
            . '.lfb-demo-form input[type="text"],.lfb-demo-form input[type="tel"],.lfb-demo-form input[type="email"]{width:100%;padding:12px;border:1px solid #ccd0d4;border-radius:8px;}
'
